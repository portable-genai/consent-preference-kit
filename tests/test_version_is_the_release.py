...
def test_the_imported_version_is_the_declared_version() -> None:
    ...
    assert consent_preference_kit.__version__ == declared, (
        f"__init__.py exports __version__ = {consent_preference_kit.__version__!r} while "
