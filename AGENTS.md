...
A shared package the systems in this organization consume. It is a library, not a
service, so it binds no profile and serves no route.

## Concrete bindings

| | |
|---|---|
| Package | `src/consent_preference_kit/` |

## What this repository still owes

Tracked by the maintainer alongside the packages this one is consumed by.
